...
[ApiController]
[Route("api/auth")]
public class AuthController(LsDbContext db, IGoogleAuthService googleAuth, IJwtService jwt) : ControllerBase
{
    [HttpPost("google")]
    ...
    private static UserDto ToDto(User user) =>
        new(user.Id, user.Email, user.Name, user.AvatarUrl, user.Role.ToString(), user.CreatedAt);
}
